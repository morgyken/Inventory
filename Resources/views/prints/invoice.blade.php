...
<html lang="en">
    <head>
        <title>Sale Invoice {{$data['sales']->id}} </title>
        <style>
            .clearfix:after {
                content: "";
                display: table;
    ...
    <body>
        ...
        <main>
            <table>
                ...
                <td class="total"><center>{{number_format($item->total,2)}}</center></td>
                </tr>
                @endforeach
                <!--
                                <tr>
                ...
                <tr>
                    ...
                    <td class="grand total"><center>{{number_format($data['sales']->goodies->sum('total'),2)}}</center></td>
                </tr>
                </tbody>
            </table>
            <div id="notices">
